...
import {faPlay,faPause,faVolumeHigh,faVolumeLow,faVolumeOff,faVolumeXmark,faForwardStep,faBackwardStep,} from "@fortawesome/free-solid-svg-icons";
        ...
        <figure key={currentMusic.title}>
          ...
          <S.InfoContainer>
            ...
            <S.ControlsContainer>
              ...
              {Playing ? ( <FontAwesomeIcon icon={faPause} onClick={togglePlay} />) 
